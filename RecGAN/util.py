...
def get_args():
    ...
    parser.add_argument('--click', type=str, default='click.txt',
                        help='location of the directory of the click data')
    parser.add_argument('--action', type=str, default='action.txt',
                        help='location of the directory of the action data')
    parser.add_argument('--reward', type=str, default='reward.txt',
                        help='location of the directory of the reward data')
    parser.add_argument('--model', type=str, default='LSTM',
                        help='type of recurrent net (RNN_Tanh, RNN_RELU, LSTM, GRU)')
    parser.add_argument('--recom', type=int, default=10,
    ...
    parser.add_argument('--n_layers_usr', type=int, default=1,
                        help='number of layers of the user behavior model')
    parser.add_argument('--n_layers_agnt', type=int, default=1,
                        help='number of layers of the user agent model')
    ...
    parser.add_argument('--optim_nll', type=str, default='sgd,lr=0.1',
                        help='type of the optimizer')
    parser.add_argument('--optim_adv', type=str, default='sgd,lr=0.1',
                        help='type of the optimizer')
    parser.add_argument('--pad', action = 'store_true',
                        help='true if the input recommendation lengths vary')
